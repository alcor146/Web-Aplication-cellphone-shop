...
?>
	...
	<body>
        ...
        $query = "SELECT * from client 
					...
					where client.Nume = '$nume' and client.Prenume = '$prenume' 
					order by client.ID_client";

		#afisez doar datele despre clientul caruia ii corespund numele si prenumele, precum si datele cardurilor lui
        ...
        if ($total > 0) {
            ...
            header("Location: ../date_clienti.php?clientul nu exista");
            exit();
        }
        $conn->close();
        ?>
